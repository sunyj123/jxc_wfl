    ...
    <div class="layui-header header">
        ...
        <ul class="layui-nav layui-layout-right">
            ...
            <li class="layui-nav-item layuimini-setting">
                <a href="javascript:;">${(Session.SPRING_SECURITY_CONTEXT.authentication.principal.username)!'xxx'}</a>
                <dl class="layui-nav-child">
                    <dd>
                        <a href="javascript:;" data-iframe-tab="${ctx.contextPath}/user/setting" data-title="基本资料"
                           data-icon="fa fa-gears">基本资料</a>
                    </dd>
                    <dd>
                        <a href="javascript:;" data-iframe-tab="${ctx.contextPath}/user/password" data-title="修改密码"
            ...
            <ul class="layui-nav layui-nav-tree layui-left-nav-tree layui-this" id="currency">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-11"
                               data-tab="purchase/index" target="_self"><i class="fa fa-user"></i><span
                                        class="layui-left-nav"> 进货入库</span></a>
                        </dd>

                        <dd class="">
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-12"
                               data-tab="return/index" target="_self"><i class="fa fa-tachometer"></i><span
                                        class="layui-left-nav"> 退货出库</span></a>
                        </dd>
                        <dd class="">
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-13"
                               data-tab="purchase/searchPage" target="_self"><i class="fa fa-tachometer"></i><span
                                        class="layui-left-nav"> 进货单据查询</span></a>
                        </dd>
                        <dd class="">
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-13"
                               data-tab="return/searchPage" target="_self"><i class="fa fa-tachometer"></i><span
                                        class="layui-left-nav"> 退货单据查询</span></a>
                        </dd>
                        <dd class="">
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-13"
                               data-tab="common/toGoodsStockPage" target="_self"><i class="fa fa-tachometer"></i><span
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-11"
                               data-tab="sale/index" target="_self"><i class="fa fa-user"></i><span
                                        class="layui-left-nav"> 销售出库</span></a>
                        </dd>

                        <dd class="">
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-12"
                               data-tab="customerReturn/index" target="_self"><i class="fa fa-tachometer"></i><span
                                        class="layui-left-nav"> 客户退货</span></a>
                        </dd>
                        <dd class="">
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-13"
                               data-tab="sale/searchPage" target="_self"><i class="fa fa-tachometer"></i><span
                                        class="layui-left-nav"> 销售单据查询</span></a>
                        </dd>
                        <dd class="">
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-13"
                               data-tab="customerReturn/searchPage" target="_self"><i class="fa fa-tachometer"></i><span
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-11"
                               data-tab="damage/index" target="_self"><i class="fa fa-user"></i><span
                                        class="layui-left-nav"> 商品报损</span></a>
                        </dd>

                        <dd class="">
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-12"
                               data-tab="overflow/index" target="_self"><i class="fa fa-tachometer"></i><span
                                        class="layui-left-nav"> 商品报溢</span></a>
                        </dd>
                        <dd class="">
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-13"
                               data-tab="common/alarmPage" target="_self"><i class="fa fa-tachometer"></i><span
                                        class="layui-left-nav"> 库存报警</span></a>
                        </dd>
                        <dd class="">
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-13"
                               data-tab="common/toDamageOverflowSearchPage" target="_self"><i
                                        class="fa fa-tachometer"></i><span class="layui-left-nav"> 报损报溢查询</span></a>
                        </dd>
                        <dd class="">
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-13"
                               data-tab="common/toGoodsStockPage" target="_self"><i class="fa fa-tachometer"></i><span
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-11"
                               data-tab="report/countSupplier" target="_self"><i class="fa fa-user"></i><span
                                        class="layui-left-nav"> 供应商统计</span></a>
                        </dd>

                        <dd class="">
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-12"
                               data-tab="report/countCustomer" target="_self"><i class="fa fa-tachometer"></i><span
                                        class="layui-left-nav"> 客户统计</span></a>
                        </dd>
                        <dd class="">
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-13"
                               data-tab="report/countPurchase" target="_self"><i class="fa fa-tachometer"></i><span
                                        class="layui-left-nav"> 商品采购统计</span></a>
                        </dd>
                        <dd class="">
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-13"
                               data-tab="report/countSale" target="_self"><i class="fa fa-tachometer"></i><span
                                        class="layui-left-nav"> 商品销售统计</span></a>
                        </dd>
                        <dd class="">
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-13"
                               data-tab="report/countDaySale" target="_self"><i class="fa fa-tachometer"></i><span
                                        class="layui-left-nav"> 按日统计</span></a>
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-13"
                               data-tab="report/countMonthSale" target="_self"><i class="fa fa-tachometer"></i><span
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd class="">
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-12"
                               data-tab="customer/index" target="_self"><i class="fa fa-tachometer"></i><span
                        ...
                        <dd class="">
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-13"
                               data-tab="goodsType/index" target="_self"><i class="fa fa-tachometer"></i><span
                                        class="layui-left-nav"> 商品分类管理</span></a>
                        </dd>
                        <dd class="">
                            <a href="javascript:;" class="layui-menu-tips" data-type="tabAdd" data-tab-mpi="m-p-i-13"
