...
<head>
    ...
    <style>
        ...
        .login-main .login-bottom .center .item .icon-1 {
            background: url(${ctx.contextPath}/images/icon-login.png) no-repeat 1px 0;
        }

        .login-main .login-bottom .center .item .icon-2 {
            background: url(${ctx.contextPath}/images/icon-login.png) no-repeat -54px 0;
        }

        .login-main .login-bottom .center .item .icon-3 {
            background: url(${ctx.contextPath}/images/icon-login.png) no-repeat -106px 0;
        }

        .login-main .login-bottom .center .item .icon-4 {
            background: url(${ctx.contextPath}/images/icon-login.png) no-repeat 0 -43px;
            position: absolute;
            right: -10px;
            cursor: pointer;
        }
        ...
        .login-main .login-bottom .center .item .icon-5 {
            background: url(${ctx.contextPath}/images/icon-login.png) no-repeat -55px -43px;
        }

        .login-main .login-bottom .center .item .icon-6 {
            background: url(${ctx.contextPath}/images/icon-login.png) no-repeat 0 -93px;
            position: absolute;
            right: -10px;
            margin-top: 8px;
            cursor: pointer;
        ...
        body {
            background: url(${ctx.contextPath}/images/loginbg.png) 0% 0% / cover no-repeat;
            position: static;
            font-size: 12px;
        }
